...
3. **Mixed Italic Headlines**: Within large headlines, alternate between regular and italic styling for specific words to create "spoken" cadence. Use gold color on italic words. Examples: "Curated _Excellence_", "The _Details_", "The _Process_". Headline splits across lines with specific words emphasized.
